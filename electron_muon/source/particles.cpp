...
Feyncalc::Particle_Ptr Electron     = std::make_shared<Feyncalc::Particle>("Electron", Particle::Type::Particle, 0.5109989461_MeV, -1, 0.5);
Feyncalc::Particle_Ptr Positron     = std::make_shared<Feyncalc::Particle>("Positron", Particle::Type::AntiParticle, 0.5109989461_MeV, 1, 0.5);

Feyncalc::Particle_Ptr Muon_Plus    = std::make_shared<Feyncalc::Particle>("Muon_+", Particle::Type::AntiParticle, 105.6583745_MeV, 1, 0.5);
Feyncalc::Particle_Ptr Muon_Minus   = std::make_shared<Feyncalc::Particle>("Muon_-", Particle::Type::Particle, 105.6583745_MeV, -1, 0.5);
